    ...
    <div className="flex gap-[2vh] flex-col items-center">
      ...
      >
        ...
        <SwiperSlide className="w-[50vw] h-[50vh]">
          <img src="/output/python_class_01-2.png" alt="error" className="w-[full] h-[full]" />
        </SwiperSlide>

        <SwiperSlide className="w-[50vw] h-[50vh]">
          <img src="/output/python_class_01-3.png" alt="error" className="w-[full] h-[full]" />
        </SwiperSlide>

        <SwiperSlide className="w-[50vw] h-[50vh]">
          <img src="/output/python_class_01-4.png" alt="error" className="w-[full] h-[full]" />
        </SwiperSlide>


        <SwiperSlide className="w-[50vw] h-[50vh]">
          <img src="/output/python_class_01-5.png" alt="error" className="w-[full] h-[full]" />
        </SwiperSlide>

        <SwiperSlide className="w-[50vw] h-[50vh]">
          <img src="/output/python_class_01-6.png" alt="error" className="w-[full] h-[full]" />
        </SwiperSlide>


        <SwiperSlide className="w-[50vw] h-[50vh]">
          <img src="/output/python_class_01-7.png" alt="error" className="w-[full] h-[full]" />
        </SwiperSlide>



        <SwiperSlide className="w-[50vw] h-[50vh]">
          <img src="/output/python_class_01-8.png" alt="error" className="w-[full] h-[full]" />
        </SwiperSlide>


        <SwiperSlide className="w-[50vw] h-[50vh]">
          <img src="/output/python_class_01-9.png" alt="error" className="w-[full] h-[full]" />
        </SwiperSlide>
        ...
        <SwiperSlide className="w-[50vw] h-[50vh]">
          <img src="/output/python_class_01-10.png" alt="error" className="w-[full] h-[full]" />
        </SwiperSlide>
        ...
        <SwiperSlide className="w-[50vw] h-[50vh]">
          <img src="/output/python_class_01-11.png" alt="error" className="w-[full] h-[full]" />
        </SwiperSlide>
