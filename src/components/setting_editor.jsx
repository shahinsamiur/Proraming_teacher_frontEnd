...
export default function SettingEditor() {
    ...
    const [selectedMode, setSelectedMode] = React.useState("Python");
    ...
    return (
        <div className="w-full h-full flex flex-col gap-[5%] p-3">
            ...
            {/* Font Size */}
            <div className="w-full h-[8%] flex items-center justify-between border-b-[0.1vw] border-[#2C2C2C] p-2">
                <span className="text-left text-[0.9vw]">languge mode </span>
                <SelectComponent
            ...
            <div className="w-full flex-1 flex flex-row gap-[1%]    p-2">
                ...
                <div className="flex-1 flex flex-col gap-[10%]">
                    ...
                    <div className="flex flex-row  gap-2 text-[1.1vw]">
                        <input type="checkbox" />
                        <h1>Enable Basic Autocomplete</h1>
                    </div>
                    ...
                    <div className="flex flex-row  gap-2 text-[1.1vw]">
                        <input type="checkbox" />
                        <h1>Enable Live Autocomplete</h1>
                    </div>
                ...
                <div className="flex-1 flex flex-col gap-[10%]">
                    ...
                    <div className="flex-1 flex justify-start items-center h-[10%]">
                        <button className="w-[10vw] h-[2.5vw] bg-[#08618E] rounded-lg text-[1vw] hover:bg-[#31B8D6]">Reset Editor</button>
                    </div>
