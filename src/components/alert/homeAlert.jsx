        ...
        >
            ...
            <div className='bg-[rgba(21,21,21,1)] w-[57%]  z-50 
                ...
                <div className='flex-1 flex flex-col gap-[10%] items-center justify-center'>
                    <h1 className='text-[2vw] '>  Are You Sure To Exit ?</h1>

                    <div className='flex flex-row gap-[2vw]'>
                        <button className='border-[0.2vw] border-[#2C2C2C] p-1 w-[8vw] h-[4vw] rounded-md hover:bg-[#08618E]' onClick={handleClick}>Exit</button>
