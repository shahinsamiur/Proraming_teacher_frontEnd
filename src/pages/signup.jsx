...
const SignupForm = () => {
  ...
  return (
    ...
    <>
      ...
      <div className=" hidden lg:flex flex-row    min-h-screen bg-[#000101]">
        <div className='w-[10%] flex justify-end items-center h-[20vh] '>
          <img src='/icons/Logo_sign.svg' alt='error' className='w-[9vw]' />
        </div>


        <div className='lg:flex flex-row w-[80%] justify-center gap-[20vh] lg:gap-[15vh] items-center '>
          <form
          ...
          >
            <div className="text-2xl no-scrollbar font-bold flex flex-row font-heading text-[#08618e] text-center mb-6">
              <Link to="/signup" className='w-1/2 text-center flex justify-center cursor-pointer  border-x-[0.01vw] border-[#08618e]'>
                <h2 className='w-1/2 text-center cursor-pointer underline'>Join Us</h2>
              </Link>
